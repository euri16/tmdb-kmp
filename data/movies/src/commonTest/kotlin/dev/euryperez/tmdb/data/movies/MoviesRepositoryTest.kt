...
class MoviesRepositoryTest : BaseTest {
    ...
    fun `getTopRatedMovies returns success with mapped movies when api call succeeds`() = runTest {
        ...
        // When
        val result = MoviesRepository.test().getTopRatedMovies(page, language)
    ...
    fun `getTopRatedMovies passes correct parameters to api`() = runTest {
        ...
        // When
        MoviesRepository.test().getTopRatedMovies(page, language)
    ...
    fun `getMovieAlternativeTitles returns success with mapped alternative titles when api call succeeds`() = runTest {
        ...
        // When
        val result = MoviesRepository.test().getMovieAlternativeTitles(movieId)
    ...
    fun `getMovieAlternativeTitles passes correct movieId parameter to api`() = runTest {
        ...
        // When
        MoviesRepository.test().getMovieAlternativeTitles(movieId)
