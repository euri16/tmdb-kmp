...
internal class MoviesRepositoryImpl(
    ...
    override suspend fun getPopularMovies(page: Int, language: String): DataResult<List<TmdbMovie>> {
    ...
    override suspend fun getUpcomingMovies(page: Int, language: String): DataResult<List<TmdbMovie>> {
        return withContext(dispatcherProvider.default) {
    ...
    override suspend fun getMovieCredits(movieId: Int, language: String): DataResult<TmdbMovieCredits> {
        return withContext(dispatcherProvider.default) {
